...
class BrowserDesktopWindowTreeHostPlatform
 ...
 public:
  ...
  BrowserDesktopWindowTreeHostPlatform(const BrowserDesktopWindowTreeHostPlatform&) = delete;
  BrowserDesktopWindowTreeHostPlatform& operator=(const BrowserDesktopWindowTreeHostPlatform&) = delete;
